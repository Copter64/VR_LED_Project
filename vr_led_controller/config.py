...
# SteamVR Settings
POINTER_ACCURACY = .99999  # Must be a float less than 1, the larger the number the more precise the virtual pointer is, the smaller lights more LEDs at a time
